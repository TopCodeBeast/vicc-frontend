...
import {
  NoBuyerSaleOffersQuery,
  NoBuyerSaleOffersQueryVariables,
} from './__generated__/index.graphql';

const NO_BUYER_SALE_OFFERS_QUERY = gql`
  query NoBuyerSaleOffersQuery(
    $cursor: String
...
` as TypedDocumentNode<NoBuyerSaleOffersQuery, NoBuyerSaleOffersQueryVariables>;

const NoBuyerSingleSaleOffers = ({
  sortType,
  sport,
}: {
...
export default NoBuyerSingleSaleOffers;

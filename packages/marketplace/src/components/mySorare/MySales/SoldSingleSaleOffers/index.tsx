...
import {
  SoldSaleOffersQuery,
  SoldSaleOffersQueryVariables,
} from './__generated__/index.graphql';

const SOLD_SALE_OFFERS_QUERY = gql`
  query SoldSaleOffersQuery(
    $cursor: String
...
` as TypedDocumentNode<SoldSaleOffersQuery, SoldSaleOffersQueryVariables>;

const SoldSingleSaleOffers = ({
  sortType,
  sport,
}: {
  ...
  const { items, count, cursor, hasMore } = extractConnectionData(
    data?.currentUser?.soldSingleSaleTokenOffers,
...
export default SoldSingleSaleOffers;

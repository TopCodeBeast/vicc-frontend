...
} from '@marketplace/components/buyActions/PaymentBox/Methods/SelectedPaymentMethodForConfirmation';
import SummaryTable, {
  Props as SummaryTableProps,
} from '@marketplace/components/buyActions/PaymentBox/SummaryTable';

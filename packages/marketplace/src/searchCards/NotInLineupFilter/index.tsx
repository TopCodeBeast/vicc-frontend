...
import { useNotInLineupFilterValue } from '@sorare/core/src/contexts/searchCards/useNotInLineupFilterValue';
...
const FILTER = VIRTUAL_TOGGLE_FILTERS.notInLineupFilter;
...
const Filter = () => {
  ...
  return (
    <Switch
      ...
      disabled={!notInLineupFilterValue}

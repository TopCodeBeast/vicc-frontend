...
export const indexStateToRoute = (
  ...
  const {
    ...
    range: {
      ...
      'vicc5.last_five_vicc5_average_score': vicc55Avg,
      'vicc5.last_fifteen_vicc5_average_score': vicc515Avg,
      'vicc5.last_five_vicc5_appearances': vicc5L5App,
      'vicc5.last_fifteen_vicc5_appearances': vicc5L15App,
      'sale.price': pr,
      serial_number: sn,
  ...
  return stringifyParams({
    ...
    [SEARCH_PARAMS.SO5_15_AVERAGE]: vicc515Avg,
    [SEARCH_PARAMS.SO5_5_AVERAGE]: vicc55Avg,
    [SEARCH_PARAMS.NBA_10_AVERAGE]: nba10Avg,
    // Work-around range bug: forcing the min/max of the connectRange triggers a refinement
    [SEARCH_PARAMS.SO5_5_APPEARANCES]:
      vicc5L5App === `${APPEARANCES_MIN}:${APPEARANCES_5_MAX}`
        ? undefined
        : vicc5L5App,
    [SEARCH_PARAMS.SO5_15_APPEARANCES]:
      vicc5L15App === `${APPEARANCES_MIN}:${APPEARANCES_15_MAX}`
        ? undefined
        : vicc5L15App,
...
const routeToState = (
  ...
  const {
    ...
    [SEARCH_PARAMS.SO5_15_AVERAGE]: vicc515Avg,
    [SEARCH_PARAMS.SO5_5_AVERAGE]: vicc55Avg,
    [SEARCH_PARAMS.SO5_15_APPEARANCES]: vicc5L15App,
    [SEARCH_PARAMS.SO5_5_APPEARANCES]: vicc5L5App,
    [SEARCH_PARAMS.NBA_10_AVERAGE]: nba10Avg,
    [SEARCH_PARAMS.GLOBAL_CUP]: globalCup,
    [SEARCH_PARAMS.UNSTACKED]: unstacked,

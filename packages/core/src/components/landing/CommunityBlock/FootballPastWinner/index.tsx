...
export const FootballPastWinner = ({ leaderboardSlug }: Props) => {
  ...
  const lastLeaderboard =
    slugData?.vicc5Root.vicc5Fixture?.vicc5Leaderboards.find(leaderboard =>
  ...
  const leaderboardDataSimplified =
    leaderboardData?.vicc5Root.vicc5Leaderboard;
  ...
  const lineupDataSimplified = lineupData?.vicc5Root.vicc5Lineup;

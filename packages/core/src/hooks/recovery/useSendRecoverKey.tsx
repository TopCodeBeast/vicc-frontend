...
import {
  ...
  PrivateKeyRecoveryPayloadsQueryVariables,
...
` as TypedDocumentNode<PrivateKeyRecoveryPayloads_CurrentUser>;
...
export const useSendRecoverKey = () => {
  ...
  const [mutate] = useMutation(SEND_WALLET_RECOVERY_MUTATION, {

...
import { JerseyShopItemListing_JerseyShopItem } from './__generated__/index.graphql';
...
type Props = {
  onSelect?: () => void;
  item: JerseyShopItemListing_JerseyShopItem;
  inDialog?: boolean;
  inventory?: boolean;
};

export const JerseyShopItemListing = ({
  onSelect,
  item,
  inDialog,
  inventory,
...
JerseyShopItemListing.fragments = {
  JerseyShopItem: gql`
    fragment JerseyShopItemListing_JerseyShopItem on JerseyShopItem {
  ...
  ` as TypedDocumentNode<JerseyShopItemListing_JerseyShopItem>,
};

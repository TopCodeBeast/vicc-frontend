...
import { LevelUpShopItemListing_LevelUpShopItem } from './__generated__/index.graphql';
...
type Props = {
  onSelect?: () => void;
  item: LevelUpShopItemListing_LevelUpShopItem;
  inDialog?: boolean;
  inventory?: boolean;
};

export const LevelUpShopItemListing = ({
  onSelect,
  item,
  inDialog,
  inventory,
...
LevelUpShopItemListing.fragments = {
  LevelUpShopItem: gql`
    fragment LevelUpShopItemListing_LevelUpShopItem on LevelUpShopItem {
  ...
  ` as TypedDocumentNode<LevelUpShopItemListing_LevelUpShopItem>,
};

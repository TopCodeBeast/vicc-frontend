...
const membershipFragment = gql`
  fragment UserGroupLeaderboard_membership on Vicc5UserGroupMembership {
    id
    score
    liveSo5Ranking: liveVicc5Ranking {
      id
      score
    }
...
UserGroupLeaderboard.fragments = {
  so5Memberships: gql`
    fragment UserGroupLeaderboard_so5Memberships on Vicc5UserGroup {
      slug
      myMembership {
        id

...
import { createVicc5UserGroupInput as createSo5UserGroupInput } from '@sorare/core/src/__generated__/globalTypes';
...
const CREATE_SO5_USER_GROUP = gql`
  mutation CreateSo5UserGroup($input: createVicc5UserGroupInput!) {
    createSo5UserGroup: createVicc5UserGroup(input: $input) {

...
import { updateSo5UserGroupInput } from '@sorare/core/src/__generated__/globalTypes';
...
export const UPDATE_SO5_USER_GROUP = gql`
  mutation UpdateSo5UserGroup($input: updateSo5UserGroupInput!) {
    updateSo5UserGroup(input: $input) {
      errors {
        path
        message
        code

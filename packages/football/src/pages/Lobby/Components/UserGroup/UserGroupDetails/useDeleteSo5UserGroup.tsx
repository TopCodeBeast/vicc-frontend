...
import { deleteVicc5UserGroupInput as deleteSo5UserGroupInput } from '@sorare/core/src/__generated__/globalTypes';
...
const DELETE_SO5USERGROUP_MUTATION = gql`
  mutation DeleteSo5UserGroupMutation($input: deleteVicc5UserGroupInput!) {
    deleteSo5UserGroup: deleteVicc5UserGroup(input: $input) {
      errors {
        message
        code
      }

...
import { Text16, Title3, Title4 } from '@sorare/core/src/atoms/typography';
...
import { PrizePoolOverview_so5Leaderboard } from './__generated__/index.graphql';
...
type Props = {
  so5Leaderboard: PrizePoolOverview_so5Leaderboard | undefined;
};

const PrizePoolOverview = ({ so5Leaderboard }: Props) => {
  ...
  const { totalRewards, rewardsConfig } = so5Leaderboard;
...
PrizePoolOverview.fragments = {
  so5Leaderboard: gql`
    fragment PrizePoolOverview_so5Leaderboard on Vicc5Leaderboard {
      slug

...
type Career_player_clubMemberships_membershipTeam_Club =
  Career_player['clubMemberships'][number]['membershipTeam'] & {
    __typename: 'Club';
  };
              ...
              .map((membership, index) => {
                ...
                return (
                  <TableRow key={id}>
                    ...
                    <TableCell>
                      {isA<Career_player_clubMemberships_membershipTeam_Club>(
                        'Club',
                        membershipTeam
                      ) &&

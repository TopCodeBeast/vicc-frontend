...
import coverDesktop from '@sorare/football/src/pages/TransferMarket/assets/starter_packs_desktop.png';
import cover from '@sorare/football/src/pages/TransferMarket/assets/starter_packs_mobile.png';

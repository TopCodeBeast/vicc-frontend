...
import coverDesktop from '@football/pages/TransferMarket/assets/starter_packs_desktop.jpg';
import cover from '@football/pages/TransferMarket/assets/starter_packs_mobile.jpg';

...
const messages = defineMessages({
  collectBlockSubtitle: {
    ...
    defaultMessage:
      'Collect, buy, sell, and trade officially licensed digital player cards from across LaLiga’s 20 clubs.',
  },
  subtitle: {
    id: 'LaLigaLanding.BuildYourLegacy.Subtitle',
    defaultMessage:
      'Create your ultimate LaLiga fantasy team and play in free competitions to win epic rewards, just like a pro club owner.',
  },
  metadatasTitle: {
  ...
  useEffect(() => {
    if (!currentUser)
      track('View Homepage Disconnected', {
        landing_variant: 'LaLigaEA_landing',
      });
  }, [currentUser, track]);
